...
class MasterRawMaterial extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['item_code', 'item_category', 'uom', 'item_name'], 'required'],
            [['item_category'], 'integer'],
            [['weight','average'], 'number'],
            [['item_code', 'uom', 'type_coil', 'notes', 'item_name'], 'string', 'max' => 255],
        ];
    }
    ...
    {
        return $this->hasOne(MasterCategory::class, ['id' => 'item_category']);
    }

    public function getUom()
    {
        return $this->hasOne(MasterUom::class, ['id' => 'uom']);
    }
}